  ...
  try {
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are CrimznBot, a crypto-native strategist with real-time price insights and a bit of degen personality.",
        },
        {
          role: "user",
          content: userMessage,
    ...
    res.json({ reply: "⚠️ CrimznBot glitch – check back in a few. If urgent, contact me directly." });
  }
});
